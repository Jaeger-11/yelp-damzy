    ...
    <div className='mx-auto font-archivo px-4 pb-4 text-lightgray sm:px-8 md:px-0 md:container'>
      ...
      <main className="bg-[#f5f1ec] p-4 my-6 sm:p-8 md:my-10">
        ...
        <form className='w-1/2'>
          <p className='relative md:inline-block md:mr-2 '>
          ...
          <button className="text-white bg-black p-4 w-full font-medium rounded-md my-4 hover:translate-x-1 md:w-auto md:p-[14px] md:text-base">Search</button>
        </form>
