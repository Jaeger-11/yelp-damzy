            ...
            <main className="md:flex-[70%]">
                ...
                <section className="p-4 border border-1 mt-4 md:p-8">
                    ...
                    <div className="flex justify-end">
                        <Link to="/addComment" ><button className="bg-black text-white font-archivo text-base font-bold flex gap-2 justify-center items-center py-4 px-6 rounded-md mr-0 hover:scale-x-95 transition-all">
